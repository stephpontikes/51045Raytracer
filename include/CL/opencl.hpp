...
struct GetInfoFunctor0 {
    ...
    const Arg0& arg0_;
    cl_int operator()(
        cl_uint param, size_type size, void* value, size_type* size_ret) { return f_(arg0_, param, size, value, size_ret); }
};
...
struct GetInfoFunctor1 {
    ...
    const Arg1& arg1_;
    cl_int operator()(
        cl_uint param, size_type size, void* value, size_type* size_ret) { return f_(arg0_, arg1_, param, size, value, size_ret); }
};
   ...
   public:
    ...
    Program(
        ...
        object_ = ::clCreateProgramWithBinary(
            ...
            deviceIDs.data(),
            lengths.data(), images.data(), (binaryStatus != nullptr && numDevices > 0) ? &binaryStatus->front() : nullptr, &error);
...
class CommandQueue : public detail::Wrapper<cl_command_queue> {
   private:
    ...
    static void initMemoryExtension(const cl::Device& device) {
        ...
        if ((pfn_clEnqueueAcquireExternalMemObjectsKHR == nullptr) && (pfn_clEnqueueReleaseExternalMemObjectsKHR == nullptr)) {
...
struct make_kernel {
    ...
    make_kernel(
        const Program& program,
        const string name,
        cl_int* err = nullptr) : functor_(FunctorType(program, name, err)) {}
...
class Semaphore : public detail::Wrapper<cl_semaphore_khr> {
   public:
    ...
    explicit Semaphore(const cl_semaphore_khr& semaphore, bool retainObject = false) : detail::Wrapper<cl_type>(semaphore, retainObject) {}
...
class CommandBufferKhr : public detail::Wrapper<cl_command_buffer_khr> {
   public:
    ...
    explicit CommandBufferKhr(const cl_command_buffer_khr& commandBufferKhr, bool retainObject = false) : detail::Wrapper<cl_type>(commandBufferKhr, retainObject) {}
...
#if defined(cl_khr_command_buffer_mutable_dispatch)
            && (pfn_clUpdateMutableCommandsKHR == nullptr) && (pfn_clGetMutableCommandInfoKHR == nullptr)
#endif /* cl_khr_command_buffer_mutable_dispatch */
        ) {
...
class MutableCommandKhr : public detail::Wrapper<cl_mutable_command_khr> {
   public:
    ...
    explicit MutableCommandKhr(const cl_mutable_command_khr& mutableCommandKhr, bool retainObject = false) : detail::Wrapper<cl_type>(mutableCommandKhr, retainObject) {}
